...
function displayPosts($str){
    ...
    if(mysql_num_rows($select)==0)
        ...
        $likeSideDisplay = ($likeStat == "liked") ? "width:30px" : "";
        ...
        echo '
        <div class="postsMain" id="'.$postId.'" status="'.$likeStat.'">
            <div class="likeSide" style="'.$likeSideDisplay.'"><div class="likesNumber">'.$likes.'</div></div>
            <div class="postsHead">
                <img src="../ProfilePics/'.$pic_id.'.jpg">
                <p>'.$fn.' '.$ln.$tens.'</p>
        </div><br />
        <p class="postContent">'.$pc.'
        </p>
    </div>';
        }//end of while
